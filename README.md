...
## Publications and linked artefacts

The repository evolves progressively and includes artefacts **associated with related publications**:

1. **ICSRS 2025**: Araaf Recta, Rim Saddem-Yagoubi, Julie Beugin, Mohamed Ghazel,"_Formal Modeling of Advanced Railway Route Management with Moving Blocks - A Property-Oriented Approach_," in ICSRS 2025, the 9th International Conference on System Reliability and Safety – IEEE, Turin, Italy, November 26-28, 2025
 (The artefacts provided correspond to the components relevant to the ICSRS paper. The fully integrated PERFORMINGRAIL-based modules will be shared in future publications)
...
- **Verification tool:** [UPPAAL](https://uppaal.org/)   
